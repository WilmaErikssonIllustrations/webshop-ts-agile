...
export const products: Product[] = [
    new Product(
        "/produktbilder/surakarameller.jpg",
        "Zing-Zong Zour",
        "Sensationellt sura!",
        8.9,
        "surt",
    ...
    new Product(
        "/produktbilder/banana-toffee.jpg",
        "Bubbs",
        "Banan & toffee",
        8.9,
        "sött",
    ...
    ,
    new Product(
        "/produktbilder/hallonlakrits2.jpg",
        "Rasporish Rolls",
        "Lagom salt & sött",
        8.9,
        "salt",
    ...
    ,
    new Product(
        "/produktbilder/saltaskallar2.jpg",
        "Salty Skulls",
        "Saltiga favoriter",
        8.9,
        "salt",
